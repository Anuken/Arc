...
public class NetLog{
     ...
     * remove all "if (NetLog.info) ..." type statements below the set level.
     */
    ...
    /**
     * Performs the actual logging. Default implementation logs to System.out. Extended and use {@link NetLog#logger} set to handle
     * logging differently.
     */
