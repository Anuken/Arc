...
/**
 * FieldHandler provides dependency-values to an {@link arc.ecs.injection.Injector}
...
public class FieldHandler{
    ...
    public void initialize(Base base, Map<String, Object> injectables){
        ...
        for(int i = 0, s = fieldResolvers.size(); i < s; i++){
            ...
            if(fieldResolver instanceof PojoFieldResolver){
        ...
        if(injectables != null && !injectables.isEmpty() && !fieldResolverFound){
            throw new IllegalArgumentException("FieldHandler lacks resolver capable of dealing with your custom injectables. Register a WiredFieldResolver or PojoFieldResolver with your FieldHandler.");
        }
    }
