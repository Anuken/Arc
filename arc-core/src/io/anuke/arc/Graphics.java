 ...
 * {@link BitmapFont}, {@link io.anuke.arc.graphics.g2d.SpriteBatch} and so on. All these classes are managed, meaning they don't need to be reloaded on a context
...
public abstract class Graphics implements Disposable{
     ...
     * </p>
     **/
    public interface Cursor extends io.anuke.arc.util.Disposable{
