...
import arc.util.compression.lz.OutWindow;
import arc.util.compression.rangecoder.BitTreeDecoder;

import java.io.IOException;

public class Decoder{
    OutWindow m_OutWindow = new OutWindow();
    arc.util.compression.rangecoder.Decoder m_RangeDecoder = new arc.util.compression.rangecoder.Decoder();
    ...
    void Init() throws IOException{
        ...
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        arc.util.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
    ...
    class LenDecoder{
        ...
        public void Init(){
            arc.util.compression.rangecoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(arc.util.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException{
    ...
    class LiteralDecoder{
        ...
        class Decoder2{
            ...
            public void Init(){
                arc.util.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
            }

            public byte DecodeNormal(arc.util.compression.rangecoder.Decoder rangeDecoder) throws IOException{
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(arc.util.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
            throws IOException{
                int symbol = 1;
                do{
