...
public class Lzma{
    ...
    public static void compress(InputStream in, OutputStream out) throws IOException{
        ...
        arc.util.compression.lzma.Encoder encoder = new arc.util.compression.lzma.Encoder();
    ...
    public static void decompress(InputStream in, OutputStream out) throws IOException{
        ...
        arc.util.compression.lzma.Decoder decoder = new arc.util.compression.lzma.Decoder();
