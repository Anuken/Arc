...
import io.anuke.arc.utils.compression.lz.OutWindow;
import io.anuke.arc.utils.compression.rangecoder.BitTreeDecoder;

import java.io.IOException;

public class Decoder{
    OutWindow m_OutWindow = new OutWindow();
    io.anuke.arc.utils.compression.rangecoder.Decoder m_RangeDecoder = new io.anuke.arc.utils.compression.rangecoder.Decoder();
    ...
    void Init() throws IOException{
        ...
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsMatchDecoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepDecoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG0Decoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG1Decoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_IsRepG2Decoders);
        io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_PosDecoders);
    ...
    class LenDecoder{
        ...
        public void Init(){
            io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_Choice);
        ...
        public int Decode(io.anuke.arc.utils.compression.rangecoder.Decoder rangeDecoder, int posState) throws IOException{
    ...
    class LiteralDecoder{
        ...
        class Decoder2{
            ...
            public void Init(){
                io.anuke.arc.utils.compression.rangecoder.Decoder.InitBitModels(m_Decoders);
            }

            public byte DecodeNormal(io.anuke.arc.utils.compression.rangecoder.Decoder rangeDecoder) throws IOException{
                int symbol = 1;
                do
            ...
            public byte DecodeWithMatchByte(io.anuke.arc.utils.compression.rangecoder.Decoder rangeDecoder, byte matchByte)
            throws IOException{
                int symbol = 1;
                do{
