package io.anuke.arc.utils.compression;
...
public class Lzma{
    ...
    static public void compress(InputStream in, OutputStream out) throws IOException{
        ...
        io.anuke.arc.utils.compression.lzma.Encoder encoder = new io.anuke.arc.utils.compression.lzma.Encoder();
    ...
    static public void decompress(InputStream in, OutputStream out) throws IOException{
        ...
        io.anuke.arc.utils.compression.lzma.Decoder decoder = new io.anuke.arc.utils.compression.lzma.Decoder();
