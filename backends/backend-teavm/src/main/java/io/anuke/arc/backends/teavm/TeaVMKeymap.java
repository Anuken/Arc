...
public class TeaVMKeymap{
    public static KeyCode getButton(int button) {
        switch(button){
            case MouseEvent.LEFT_BUTTON: return KeyCode.MOUSE_LEFT;
    ...
    public static KeyCode getCode(int keyCode) {
        switch (keyCode) {
            case KEY_ALT: return KeyCode.ALT_LEFT;
            case KEY_BACKSPACE: return KeyCode.BACKSPACE;
            case KEY_CTRL: return KeyCode.CONTROL_LEFT;
            ...
            case KEY_PAGEDOWN: return KeyCode.PAGE_DOWN;
            case KEY_PAGEUP: return KeyCode.PAGE_UP;
            case KEY_RIGHT: return KeyCode.RIGHT;
            case KEY_SHIFT: return KeyCode.SHIFT_LEFT;
            case KEY_TAB: return KeyCode.TAB;
            case KEY_UP: return KeyCode.UP;
            case KEY_PAUSE: return KeyCode.UNKNOWN; // FIXME
            case KEY_CAPS_LOCK: return KeyCode.UNKNOWN; // FIXME
            case KEY_SPACE: return KeyCode.SPACE;
            case KEY_INSERT: return KeyCode.INSERT;
            case KEY_0: return KeyCode.NUM_0;
            case KEY_1: return KeyCode.NUM_1;
            case KEY_2: return KeyCode.NUM_2;
            case KEY_3: return KeyCode.NUM_3;
            case KEY_4: return KeyCode.NUM_4;
            case KEY_5: return KeyCode.NUM_5;
            case KEY_6: return KeyCode.NUM_6;
            case KEY_7: return KeyCode.NUM_7;
            case KEY_8: return KeyCode.NUM_8;
            ...
            case KEY_LEFT_WINDOW_KEY: return KeyCode.UNKNOWN; // FIXME
            case KEY_RIGHT_WINDOW_KEY: return KeyCode.UNKNOWN; // FIXME
            case KEY_NUMPAD0: return KeyCode.NUMPAD_0;
            case KEY_NUMPAD1: return KeyCode.NUMPAD_1;
            case KEY_NUMPAD2: return KeyCode.NUMPAD_2;
            case KEY_NUMPAD3: return KeyCode.NUMPAD_3;
            case KEY_NUMPAD4: return KeyCode.NUMPAD_4;
            case KEY_NUMPAD5: return KeyCode.NUMPAD_5;
            case KEY_NUMPAD6: return KeyCode.NUMPAD_6;
            case KEY_NUMPAD7: return KeyCode.NUMPAD_7;
            case KEY_NUMPAD8: return KeyCode.NUMPAD_8;
            case KEY_NUMPAD9: return KeyCode.NUMPAD_9;
            case KEY_MULTIPLY: return KeyCode.UNKNOWN; // FIXME
            case KEY_ADD: return KeyCode.PLUS;
            case KEY_SUBTRACT: return KeyCode.MINUS;
            case KEY_DECIMAL_POINT_KEY: return KeyCode.PERIOD;
            case KEY_DIVIDE: return KeyCode.UNKNOWN; // FIXME
            ...
            case KEY_NUM_LOCK: return KeyCode.NUM;
            case KEY_SCROLL_LOCK: return KeyCode.UNKNOWN; // FIXME
            case KEY_SEMICOLON: return KeyCode.SEMICOLON;
            case KEY_EQUALS: return KeyCode.EQUALS;
            case KEY_COMMA: return KeyCode.COMMA;
            case KEY_DASH: return KeyCode.MINUS;
            case KEY_PERIOD: return KeyCode.PERIOD;
            case KEY_FORWARD_SLASH: return KeyCode.SLASH;
            case KEY_GRAVE_ACCENT: return KeyCode.BACKTICK;
            case KEY_OPEN_BRACKET: return KeyCode.LEFT_BRACKET;
            case KEY_BACKSLASH: return KeyCode.BACKSLASH;
            case KEY_CLOSE_BRACKET: return KeyCode.RIGHT_BRACKET;
            case KEY_SINGLE_QUOTE: return KeyCode.APOSTROPHE;
