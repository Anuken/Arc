...
import io.anuke.arc.backends.ios.custom.UIAcceleration;
import io.anuke.arc.backends.ios.custom.UIAccelerometerDelegate;
import io.anuke.arc.backends.ios.custom.UIAccelerometerDelegateAdapter;
    ...
    protected void setupAccelerometer(){
        if(config.useAccelerometer){
            accelerometerDelegate = new UIAccelerometerDelegateAdapter(){
                ...
                public void didAccelerate(io.anuke.arc.backends.ios.custom.UIAccelerometer accelerometer, @Pointer long valuesPtr){
                    io.anuke.arc.backends.ios.custom.UIAcceleration values = UI_ACCELERATION_WRAPPER.wrap(valuesPtr);
            ...
            io.anuke.arc.backends.ios.custom.UIAccelerometer.getSharedAccelerometer().setDelegate(accelerometerDelegate);
            io.anuke.arc.backends.ios.custom.UIAccelerometer.getSharedAccelerometer().setUpdateInterval(config.accelerometerUpdate);
        }
    }
